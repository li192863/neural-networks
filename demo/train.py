...
def get_dataloader(dataset, opt):
    ...
    :return:
    """
    training_data = dataset(root='../../datasets/', train=True, download=True, transform=ToTensor())
    test_data = dataset(root='../../datasets/', train=False, download=True, transform=ToTensor())
